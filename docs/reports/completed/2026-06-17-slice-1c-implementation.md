...
**状态**：completed
**完成时间**：2026-06-17
**对应 progress**：[`docs/progress/2026-06-17-slice-1c-implementation.md`](../../progress/2026-06-17-slice-1c-implementation.md)
**规格来源**：[`docs/progress/2026-06-17-slice-1c-spec.md`](../../progress/2026-06-17-slice-1c-spec.md)
...
# 2. 前端构建
pnpm --filter @marketing-monitor/admin build     # → admin/dist（rrweb-player 独立 chunk 129 KB）
pnpm --filter @marketing-monitor/visitor-sdk build # → sdk.js 300 KB（含 rrweb inline）
