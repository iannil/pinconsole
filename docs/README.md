...
| 路径 | 用途 | 当前内容 |
|---|---|---|
| [`project-status.md`](./project-status.md) | rolling 项目状态（LLM 友好） | v1 release ready（2026-06-26） |
| [`progress/`](./progress/) | 当前正在进行的修改单元（一改一文） | 0 项活跃（当前已完成归档） |
| [`reports/completed/`](./reports/completed/) | 已完成的切片 spec + implementation 报告 | v1 全切片 1a-1z + 1aa-1ai-h + v1-e2e + v1-followups + go1-go7 + ts1-ts3 + vendor-rrweb + page-editor + 后续修复，共 103+ 报告 |
| [`audits/`](./audits/) | 审计发现（冗余/过期/错误梳理 + 测试覆盖率/质量评估） | [`initial-cleanup`](./audits/2026-06-17-initial-cleanup.md) / [`deep-audit (80 findings)`](./audits/2026-06-18-deep-audit.md) / [`1k-1u-regression`](./audits/2026-06-18-1k-1u-regression.md) / [`test-confidence-audit`](./audits/2026-06-19-test-confidence-audit.md) / [`test-health-audit`](./audits/2026-06-19-test-health-audit.md) / [`coverage-assessment`](./audits/2026-06-20-coverage-assessment.md) / [`go-phase-1-coverage-final`](./audits/2026-06-21-go-phase-1-coverage-final.md) |
...
| [`marketing/`](./marketing/) | maintainer 对外推广策略（独立于 OSS 产品） | 4 份 GTM/设计文档，见[子目录 README](./marketing/README.md) |
...
| **vendor-rrweb** | rrweb 源码硬分叉至 `packages/replay-core`，admin 钻穿直持 Replayer | [spec](./reports/completed/2026-06-25-vendor-rrweb-spec.md) | [impl](./reports/completed/2026-06-25-vendor-rrweb-implementation.md) | 🟢 |
| **page-editor** | Post-v1 页面编辑器：proto 类型 + PG 迁移 + Go CRUD + API + Admin UI + SDK 配置驱动 | [dev 日志](./reports/completed/2026-06-26-page-editor-dev.md) · [pe-1 spec](./reports/completed/2026-06-26-slice-pe1-spec.md) · [pe-2 spec](./reports/completed/2026-06-26-slice-pe2-spec.md) · [pe-3 spec](./reports/completed/2026-06-26-slice-pe3-spec.md) · [wv-1 spec](./reports/completed/2026-06-26-slice-wv1-spec.md) | ✅ 全部提交（pe-1 `19eca36` / pe-2 `42a5625` / pe-3 `1dcda74`） | 🟡 |
...
> **累计**(2026-06-26 实测):🟢 ×24(4 strict + 1 aligned + 19 touched:新增 vendor-rrweb) / 🟡 ×9 / 🔴 ×0。详细 badge 分配见 [`project-status.md`](./project-status.md) §5。
