...
import { snapshot, serializeNodeWithId } from '../src/snapshot';
import { _isBlockedElement } from '../src/snapshot/snapshot';
import { elementNode, serializedNodeWithId } from '../src/types';
import { Mirror, absolutifyURLs } from '../src/snapshot/utils';

// Helper: create DocumentFragment from HTML (replaces JSDOM.fragment)
...
describe('isBlockedElement()', () => {
  ...
  const render = (html: string): HTMLElement =>
    fragment(html).querySelector('div')!;
