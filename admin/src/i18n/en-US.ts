export default {
  ...
  pages: {
    ...
    draft: 'Draft',
    published: 'Published',
    no_pages: 'No pages yet. Create your first landing page.',
  ...
  page_leads: {
    ...
    back: 'Back',
    no_leads: 'No submissions yet.',
    submitted_at: 'Submitted at',
    fields: 'Fields',
  },
  domains: {
    title: 'Custom Domains',
    subtitle: 'Connect your own domain for HTTPS landing pages.',
    ...
    confirm_delete: 'Remove {domain}? This will stop HTTPS service for this domain.',
    error_add: 'Failed to add domain. Check the domain format or try again.',
    error_delete: 'Failed to remove domain.',
    dns_title: 'DNS Setup',
    dns_step_1: 'Add an A record pointing to your server IP, or a CNAME record pointing to your platform domain.',
    dns_step_2: 'Wait for DNS propagation (may take a few minutes).',
    dns_step_3: 'Once the certificate is issued (Status → Active), your domain is ready.',
  },
} as const;
